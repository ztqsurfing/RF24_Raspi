...
public:
  ...
  //tq add
  //Test whether there is dsdv message available for this node
  bool available_dsdv(void);
  ...
  //tq add
  //read a message from dsdv_queue
  uint16_t read_dsdv(RF24NetworkHeader& header, void* message, uint16_t maxlen);
